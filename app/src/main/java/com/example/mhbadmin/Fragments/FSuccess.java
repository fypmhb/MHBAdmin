...
public class FSuccess extends Fragment {
    ...
    private void connectivity() {
        ...
        RecyclerView rvSucceed = (RecyclerView) fragmentView.findViewById(R.id.rv_hall_marquee_success);

        filterLists = new ArrayList<>();

        requestBookingAdapter = new RequestBookingAdapter(context, "Succeed Bookings", filterLists);

        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity(), RecyclerView.VERTICAL, false);

        rvSucceed.setLayoutManager(mLayoutManager);
        rvSucceed.setAdapter(requestBookingAdapter);
    }
    ...
    private void getDataFromFireBase() {
        ...
        cGetRequestBookingData.getSucceedBookingsData();
