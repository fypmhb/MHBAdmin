...
public class CSubHallData {
    ...
    CSubHallData(String sSubHallName, String sSubHallFloorNo, String sHallCapacity, String sChickenPerHead, String sMuttonPerHead, String sBeefPerHead, String sSweetDish, String sSalad, String sDrink, String sNan, String sRise, List<String> sLGetAddHallImagesDownloadUri) {
    ...
    CSubHallData(String sSubHallName, String sHallCapacity, String sChickenPerHead, String sMuttonPerHead, String sBeefPerHead, String sSweetDish, String sSalad, String sDrink, String sNan, String sRise, List<String> sLGetAddHallImagesDownloadUri) {
        this.sSubHallName = sSubHallName;
        this.sHallCapacity = sHallCapacity;
        this.sChickenPerHead = sChickenPerHead;
        this.sMuttonPerHead = sMuttonPerHead;
